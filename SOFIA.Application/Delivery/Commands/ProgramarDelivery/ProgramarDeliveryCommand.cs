...
public record ProgramarDeliveryCommand(Guid VentaId, string PlataformaServicio, string? CodigoRastreo, EstadoDespacho EstadoDespacho, string DireccionEntrega, string? RepartidorNombre, string? EvidenciaFotograficaUrl) : IRequest<Result<Guid>>;
